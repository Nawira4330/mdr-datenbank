-- Migration: manuelle Traeger/Betroffen/Frei-Bestaetigung je nicht
-- getesteter Erbkrankheit (Klick-Buttons in horse.html/verpaarung.html,
-- siehe js/horseForm.js). Im Supabase Dashboard unter "SQL Editor"
...
alter table public.horses
  add column if not exists disease_gene_overrides jsonb;
