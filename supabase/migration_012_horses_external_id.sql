-- Migration: neues freies ID-Feld bei Pferden (z.B. fuer eine laengere
-- Nummer zur eigenen Zuordnung, rein informativ). Im Supabase Dashboard
-- unter "SQL Editor" einfuegen und ausfuehren.
--
